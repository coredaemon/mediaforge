...
class ProcessedMediaRecord(Base):
    ...
    tv_show_title: Mapped[str | None] = mapped_column(String(512))
    tv_season_number: Mapped[int | None] = mapped_column(Integer)
    tv_episode_number: Mapped[int | None] = mapped_column(Integer)
    tmdb_show_id: Mapped[int | None] = mapped_column(Integer)
