...
class AppSettings(Base):
    ...
    cloud_ai_fallback_provider: Mapped[str | None] = mapped_column(String(64))
    cloud_ai_fallback_api_key: Mapped[str | None] = mapped_column(Text)
    cloud_ai_fallback_model: Mapped[str | None] = mapped_column(String(256))
    openrouter_api_key: Mapped[str | None] = mapped_column(Text)
    openrouter_base_url: Mapped[str | None] = mapped_column(Text)
    openrouter_fast_chain: Mapped[str | None] = mapped_column(Text)
    openrouter_smart_chain: Mapped[str | None] = mapped_column(Text)
    openrouter_last_models_cache: Mapped[str | None] = mapped_column(Text)
